...
Tool 3: 'optimize_slots()' - this tool takes input query_demand from get_query_demand() output and 
        input total_slot_hours_consumed and total_slot_used from get_bigquery_slot_utilization_for_project(days_back) output and provides
