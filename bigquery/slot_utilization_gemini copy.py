...
def get_bigquery_slot_utilization_for_project(project_id: str, days_back: int = 1):
    """
    ...
    Args:
        project_id (str): The ID of the Google Cloud project to analyze.
    ...
    service_account_file = 'C:/Vishwajeet/GCP/cost_optimization/bigquery/abc.json'
...
if __name__ == "__main__":
    ...
    slot_data = get_bigquery_slot_utilization_for_project(YOUR_PROJECT_ID, DAYS_TO_ANALYZE)
